...
const passwordConfrimation = document.querySelector('#password-confirmation')
...
form.addEventListener('submit', e => {
    ...
    if (passwordConfrimation.value !== password.value) {
        errorMessages.push("Password must match.");
    }
    //      4. Ensure the terms checkbox is checked
    if (!terms.checked) {
        errorMessages.push("Must agree to the terms.");
    }
